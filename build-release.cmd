...
"%WINDIR%\Microsoft.NET\Framework\v4.0.30319\MSBuild.exe" vspte.Wizards/vspte.Wizards.csproj /p:Configuration=Release /m
mkdir bin
copy vspte\bin\Release\vspte.exe.config bin\
copy vspte.Wizards\bin\Release\vspte.Wizards.dll bin\
